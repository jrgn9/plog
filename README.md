...
| \-d          | \--delete    |** last, id                 | Delete an entry. Creates a backup file which can be reverted. Use with 'last' or 'id' to delete based on those options. Provide two id numbers (ascending) for deleting a range of entries.                                                                   |

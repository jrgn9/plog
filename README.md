...
| \-p          | \--print     | id, date, author, search, last | Prints log entries to terminal. Prints the whole file if no extra arguments are present. Use 'id', 'date', 'author', 'search' or 'last' to filter out entries. Provide two dates or id numbers for printing a range of entries.                                   |
